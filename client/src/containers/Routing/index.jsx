...
import { loadCurrentUser, logout, login, registration, updateUser } from 'src/containers/Profile/actions';
...
class Routing extends React.Component {
    ...
    renderForgotPassword = forgotProps => (
        <ForgotPassword
            {...forgotProps}
        />
    );

    renderPasswordReset = resetProps => (
        <PasswordReset
            {...resetProps}
        />
    );
                    ...
                    <div className="fill">
                        ...
                        <main className="fill">
                            <Switch>
                                ...
                                <Route path="/reset" render={this.renderPasswordReset} />
...
const actions = { loadCurrentUser, login, logout, registration, applyPost, updateUser };
